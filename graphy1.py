...
class env(object):
    ...
    def __init__(self,data) -> None:
        ...
        self.distination=np.loadtxt("end_hulu.txt")
        # self.distination = []
    ...
    def reset(self):
        ...
        # if(self.destination_name=='天津'):
            # self.distination = self.destination_name_list[0:40]
        # elif(self.destination_name=='大连'):
            # self.distination = self.destination_name_list[41:80]
        # elif(self.destination_name=='烟台'):
            # self.distination = self.destination_name_list[81:120]
        # elif(self.destination_name=='秦皇岛'):
            # self.distination = self.destination_name_list[120:160]
